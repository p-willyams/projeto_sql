...
) AS t(cod_usuario INT, data_cadastro DATE, faixa_etaria VARCHAR(50),
...
) AS t(cod_produto INT, nome_produto VARCHAR(200), categoria_produto VARCHAR(100),
...
) AS t(id_venda INT, cod_usuario INT, cod_produto INT, data_compra TIMESTAMP,
        forma_pagamento VARCHAR(50), quantidade INT, valor_compra NUMERIC,
        data_prevista_entrega DATE, data_entrega DATE);
